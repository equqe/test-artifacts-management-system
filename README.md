...
шаги работают(макс. 5 шагов), убрал поле кейсов, убрал поле глобальных статусов, сейчас будет коммит с добавлением тесткейсов и автоматическим автором)

насчет сортировки - при выборе категории для фильтра обновляется страничка полностью, поэтому установил значение в ---
