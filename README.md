...
runtime поставил, автоавтора тоже
насчет добавления кейсов в во время создания багрепортов - быстрее будет сделать список чекбоксов с overflow(чтобы список кейсов не залезал на другие элементы и его можно было листать), потому что добавить форму в форме при создании будет намного более муторно

шаги сейчас закоммичу
