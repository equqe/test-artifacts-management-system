# Generated by Django 5.0.4 on 2024-05-14 19:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('LD', 'Главный тестировщик'), ('DF', 'Тестировщик')], default='DF', max_length=2)),
        ...
        migrations.CreateModel(
            name='TestSet',
            fields=[
                ('case_status', models.CharField(choices=[('SC', 'Провален'), ('FL', 'Успешно'), ('UD', '-')], default='UD', max_length=2)),
